...
var circumf = function circumf(radius) {
    return 2 * Math.PI * radius;
};

exports.area = area;
exports.circumf = circumf;
...
var variabl = function variabl() {
    return exports.variable = variable += 1, variable - 1;
};
...
exports.variabl = variabl;
var fileName = exports.fileName = 'qinchaolover';
...
// 17
console.log((0, _export.sumbig)(10, 6));

//import 具有变量提升，默认提到文件头部

// 25
console.log((0, _export.square)(9));
...
//firstName
console.log(_export.fileName);

//--------------------circle
console.log("面积：" + circle.area(4));
console.log("周长：" + circle.circumf(4));

(0, circle.default)(); //circle default

console.log("variable1:" + _export.variable);
(0, _export.variabl)();
console.log("variable2:" + _export.variable);

},{"./circle":2,"./export":3,"lodash":1}]},{},[4]);
